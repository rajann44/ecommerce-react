        ...
        <div class="relative flex h-full flex-col text-gray-600 md:flex-row">
          <div class="relative p-8 md:w-4/6">
            <div class="flex flex-col md:flex-row">
              <h2 class="mb-2 text-2xl font-black">Chromatic</h2>
              <span class="ml-2 text-xs uppercase">Brushstroke</span>
            </div>
            <p class="mt-3 font-sans text-base tracking-normal">
              Introducing Chromatic Brushstroke, the perfect addition to any art
              enthusiast's collection. These one-of-a-kind brushstrokes are
              created using a unique blend of high-quality pigments, resulting
              in a vibrant and dynamic composition.
            </p>
            <div class="flex flex-col md:flex-row md:items-end">
              <p class="mt-6 text-4xl font-black">
                $70,000<sup class="align-super text-sm">00</sup>
              </p>
              <span class="ml-2 text-xs uppercase">
                Only 1 in the whole world
              </span>
            </div>
